...
({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the people behind SVR Electronics — 15+ years of repairing, supplying and selling premium televisions across Telangana." },
...
function About() {
  return (
    <>
      <PageHero eyebrow="About us" title="Engineered for picture-perfect peace of mind." subtitle="SVR Electronics has been the quiet name behind reliable televisions in thousands of homes and businesses across Telangana since 2010." />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal delay={0.15}>
            ...
            <div className="mt-8 grid grid-cols-3 gap-3">
              {[["15+", "Years"], ["25000+", "TVs serviced"], ["98%", "Satisfaction"]].map(([v, l]) => (
